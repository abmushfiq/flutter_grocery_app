                ...
                RefreshIndicator(
                  child: PaginateFirestore(
                    ...
                    header: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text('Findout quality products near you',style: TextStyle(
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text(document['address'],overflow: TextOverflow.ellipsis,
                                    ...
                                    Text(
                                      '${getDistance(document['location'])}Km',overflow: TextOverflow.ellipsis,
                                    ),
                                    SizedBox(
                                      height: 3,
                                    ),
                    ...
                    query: FirebaseFirestore.instance.collection('vendors')
                        ...
                        .where('isTopPicked',isEqualTo:true).orderBy('shopName'),
                    listeners: [
                    ...
                    footer: Padding(
                      ...
                      child: Container(
                        child: Stack(
                          children: [
                            Center(
                              child: Text('***That all folks***',style: TextStyle(color: Colors.grey),),
                            ),
