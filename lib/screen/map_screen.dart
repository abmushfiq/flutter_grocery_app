...
class _MapScreenState extends State<MapScreen> {
  ...
  LatLng currentLocation = LatLng(7.2906, 80.6337) ;
  ...
  Widget build(BuildContext context) {
    ...
    void onCraeted(GoogleMapController controller){
      setState(() {
        ...
        child: Stack(
          children: [
            ...
            Center(child: Container(
                ...
                child: Image.asset('images/marker.png', color: Theme.of(context).primaryColor),
            ),
            ),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextButton.icon(
                          ...
                          label: Flexible(
                            child: Text(_locating ? 'Locating...': locationData
                            .selectedAddress == null ? 'Locating...' : locationData.selectedAddress.featureName,
...
//got current latitude and longitude. now we will display our current position in google map
